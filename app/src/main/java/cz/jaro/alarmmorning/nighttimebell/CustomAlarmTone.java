...
public class CustomAlarmTone {
    ...
    private boolean copyRawFile(int resID, String title, boolean setAsDefault) {
        ...
        try {
            ...
            contentValues.put(MediaStore.MediaColumns.TITLE, title); // TODO Horfix - Android does not support title localization. Therefore we use title in current locale
