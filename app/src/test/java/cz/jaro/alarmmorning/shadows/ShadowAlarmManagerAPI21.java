...
// TODO Hotfix - This class exists only because Robolectric supports API level 21 and we are using methods indroduced afterwards. Remove this class when Roboelectric supports implemented methods.
